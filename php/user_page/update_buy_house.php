...
<body>
    <main>
        <a href="../../html/user_page/houses_for_sale.php"><i class="fa-solid fa-arrow-left"></i></a>
        ...
        <?php
            if(isset($_POST['update'])){
                ...
                $sql_1 = "UPDATE house_table SET  house_name ='$house_name', house_price ='$house_price', house_location = '$house_location', house_bedroom ='$house_bedroom', house_bathroom ='$house_bathroom', house_area = '$house_area' WHERE buy_or_sale='1' AND house_id='$house_id'";
        ...
        <?php
            $sql = "SELECT * FROM house_table WHERE buy_or_sale='1' AND house_id='$house_id'";
