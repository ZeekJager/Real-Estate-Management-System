<?php
    ...
    $_SESSION['from_page'] = "home_page";
    $_SESSION['from_page_2'] = "home_page";
    ...
    <section class="section_1">
        ...
        <header>
            ...
            <nav>
                ...
                <a href="user_page/dash_board_page.php" style="position: static; border-radius: 100%;"><img src="../z_databse_assets/<?php if($row['user_image']){ echo $row['user_image']; }else{ echo "user_profile_icon.png"; }?>" style="border-radius: 100%;" width="30" height="30"></a>
            </nav>
        </header>
        ...
        <header>
            ...
            <?php
                if(isset($_GET['email_exists'])){
                    ?><div class="style fail">E-mail already exists try another e-mail</div><?php
                }
                if(isset($_GET['subscribed'])){?>
                    <div class="style pass">
                        <div>Your subscribtion was successfull</div>
                        <div>We will update you on any relevant issues through your e-mail</div>
                    </div><?php
                }
                if(isset($_GET['subscribtion_failed'])){
                    ?><div class="style fail">Subscribtion failed, Please try again</div><?php
                }
            ?>


            <form action="../php/home_page/subscriber_recording.php" method="post">
...
<?php
        ...
        header("Location: log_in_page.php?home_Page=2");
    }
?>