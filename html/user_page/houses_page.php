        ...
        <!--houses_container-->
            <div class="display">
                ...
                <?php
                    ...
                    $user_table = mysqli_query($connection, $sql1);
                    $row = mysqli_fetch_assoc($user_table);
                ?>


                <div class="info">
                    <img src="../../assets/architecture_design_of_house.png" width="160" height="100">
                    <p>Hello, <span><?php if(empty($row['first_name']) && empty($row['last_name'])){ echo "N/A"; }else{ echo $row['first_name']." ".$row['last_name']; } ?></span></p>
                    <p>Look at all the house you uploaded for sale and/or rent</p>
                    ...
                    <div class="down houses_down">
                        <label><i class="fa-solid fa-arrow-up"></i></label>
                        <div class="buttons">
                            <a href="houses_for_sale.php">For Sale</a>
                            <a href="houses_for_rent.php">For Rent</a>
                        </div>
                    </div>
                </div>
            </div>
