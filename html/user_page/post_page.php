    ...
    <main>
        <!--upload_container-->
            <div class="display">
                ...
                <div class="info">
                    <?php
                        if(isset($_GET['video_uploaded'])){
                            ?><div style="color: lightgreen; font-weight: 600; text-align: center;">Video uploaded successfully</div><?php
                        }
                    ?>


                    <img src="../../assets/two_people_uploading_a_file.png" width="160" height="100">
                    <p>What's up, <span><?php if(empty($row['first_name']) && empty($row['last_name'])){ echo "N/A"; }else{ echo $row['first_name']." ".$row['last_name']; } ?></span></p>
                    <p>You got to upload a video to promot the house you want to sale or rent.</p>
                    ...
                    <div class="down upload_down">
                        ...
                        <form action="../../php/user_page/upload_video.php" method="post" enctype="multipart/form-data">
                            <div class="image">
                                <input id="upload_video" type="file" accept="video/*" name="video" required>
                            ...
                            <div class="fields" id="field">
                                <div>
                                    <i class="fa-solid fa-tape"></i><input type="text" placeholder="Video Title" name="video_title" required>
                                    <i class="fa-solid fa-square"></i><input type="text" placeholder="Video_description" name="video_description" required>
                                </div>
                            </div>
