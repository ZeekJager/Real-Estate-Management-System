...
<body>
    ...
    <!--for_rent_houses_display-->
    <div class="container">
        <div class="style">
            <div class="display">
                <h1>Your houses for <span>rent</span></h1>
                ...
                <div class="buttons">
                    <a href="houses_for_sale.php"><button>Go to sale</button></a>
                </div>
                ...
                <div class="houses_container2" id="houses_container2">
                    ...
                    <?php
                        $sql_1 = "SELECT * FROM house_table WHERE buy_or_sale='0' AND user_id = '$user_id' ORDER BY house_price";
                        $rent_table = mysqli_query($connection, $sql_1);
                    ...
                    <div class="houses" id="houses">
                        ...
                        <div class="slide">
                            ...
                            <a href="../../php/user_page/update_rent_house.php?house_id=<?php echo $row['house_id']; ?>" name="update">Update</a>
                            <a href="../../php/user_page/delete_rent_house.php?house_id=<?php echo $row['house_id']; ?>" name="delete">Delete</a>
                        </div>
                    </div>
                    ...
                    <?php
                            ...
                            <div style="color: blue; font-weight: 600;">You did dot upload any house for rent</div><?php
                        }
                    ?>
                </div>
            </div>
