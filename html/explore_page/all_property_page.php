<?php
    ...
    $_SESSION['from_page'] = "explore_page_all";
?>
...
<body>
    ...
    <section class="section_1" id="section_1">
        ...
        <!--main-->
        <main>
            <a href="all_property_page.php"><p style="border-top-right-radius: 10px; border-bottom-right-radius: 10px; background: #303030;" id="option"><i class="fa-solid fa-house-flag"></i> All</p></a>
            <a href="featured_property_page.php"><p id="option"><i class="fa-solid fa-house"></i> Featured</p></a>
    ...
    <section class="section_2" id="section_2">
        ...
        <main id="main">
            ...
            <div class="container">
                ...
                <?php
                    $sql_1 = "SELECT * FROM house_table ORDER BY house_price";
