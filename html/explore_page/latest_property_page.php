<?php
    ...
    $_SESSION['from_page'] = "explore_page_latest";
?>
...
<body>
    ...
    <section class="section_1" id="section_1">
        ...
        <main>
            ...
            <a href="latest_property_page.php"><p style="border-top-right-radius: 10px; border-bottom-right-radius: 10px; background: #303030;" id="option"><i class="fa-solid fa-house-flag"></i> Latest</p></a>
        </main>
    </section>
