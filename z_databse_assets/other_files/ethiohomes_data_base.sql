...
--
-- Dumping data for table `house_rating_table`
--

INSERT INTO `house_rating_table` (`id`, `from_user_id`, `house_id`) VALUES
(84, 1, 40),
(85, 1, 32);
...
--
-- Dumping data for table `house_review`
--

INSERT INTO `house_review` (`id`, `from_user_id`, `house_review`, `house_id`, `to_user_id`, `viewed`, `date`) VALUES
(57, 1, 'Good house', 40, 3, 1, '2024-06-25'),
(58, 1, 'hi', 32, 2, 0, '2024-06-25');
...
(27, 'h4.webp', 'h4.webp', '', '', '', '', 'House for sale at ayat', 50000, 'ayat', 5, 3, 200, 1, 0, 0, 0, 1, '2024-06-24', 1),
(28, 'h11.jpg', 'h11.jpg', '', '', '', '', 'New duplex', 98000, 'Mexico', 6, 4, 150, 1, 0, 0, 0, 1, '2024-06-24', 1),
(29, 'h12.webp', 'h12.webp', '', '', '', '', 'Luxury House', 99000, 'Bole', 5, 3, 175, 1, 0, 0, 0, 1, '2024-06-24', 1),
(30, 'h5.jpg', 'h5.jpg', '', '', '', '', 'Modern house', 60000, 'Kera', 3, 1, 94, 1, 0, 0, 0, 1, '2024-06-24', 1),
(31, 'h16.jpg', 'h16.jpg', '', '', '', '', 'Beach House', 100000, 'hawassa', 5, 4, 300, 1, 0, 0, 0, 1, '2024-06-24', 1),
(32, 'h13.jpg', 'h13.jpg', '', '', '', '', 'Urgent house for sale', 40000, 'Jemo', 5, 3, 94, 1, 0, 2, 1, 1, '2024-06-24', 2),
(33, 'h17.jpg', 'h17.jpg', '', '', '', '', 'Villa', 56000, 'Merkato', 3, 2, 250, 1, 0, 0, 0, 1, '2024-06-24', 2),
(34, 'h6.jpg', 'h6.jpg', '', '', '', '', 'Two story house', 60000, 'Summit', 5, 2, 150, 1, 0, 0, 0, 1, '2024-06-24', 2),
(35, 'h18.webp', 'h18.webp', '', '', '', '', 'Country side compound', 65000, 'country side', 4, 3, 150, 1, 0, 0, 0, 1, '2024-06-24', 2),
(36, 'h3.webp', 'h3.webp', '', '', '', '', 'Dark color house', 50000, 'Alem gena', 6, 3, 140, 1, 0, 0, 0, 1, '2024-06-24', 2),
(38, 'h15.jpg', 'h15.jpg', '', '', '', '', 'House from the coldes', 55000, '22 mazoria', 5, 2, 120, 1, 0, 0, 0, 1, '2024-06-24', 3),
(39, 'h2.webp', 'h2.webp', '', '', '', '', 'Finished duplex', 80000, 'Bole', 5, 2, 220, 1, 0, 0, 0, 1, '2024-06-24', 3),
(40, 'h1.webp', 'h1.webp', '', '', '', '', 'Lake side residential', 40000, 'Ayat', 4, 2, 120, 1, 0, 2.5, 1, 1, '2024-06-24', 3),
(41, 'h14.jpg', 'h14.jpg', '', '', '', '', 'Modern two story house', 96000, 'Megnaga', 7, 5, 150, 1, 0, 0, 0, 1, '2024-06-24', 3),
(42, 'h8.jpeg', 'h8.jpeg', '', '', '', '', 'Big House', 78000, 'Betel', 5, 3, 110, 1, 0, 0, 0, 1, '2024-06-24', 3),
(44, 'h10.jpg', 'h10.jpg', '', '', '', '', 'Mansion', 99000, 'Bole', 7, 15, 150, 1, 0, 0, 0, 1, '2024-06-24', 4);
...
(9, 1, 'House for sale at ayat', 'ethiohomes_promotion_video.mp4', 0, 0);
...
(1, 'pp1.png', 'Eyasu', 'Getachew', 'Eyasu', 'eyasugetachew@gmail.com', 'eyasu12345', 908653456, 'Longtiude: 38.7439 and Latitude: 9.026 , Addis Ababa , AA , Ethiopia', 2147483647, 'chapa-12345', 1, 0, 0, 0, 0, 0, 0, 0, '2024-06-04'),
...
(4, 'pp4.webp', 'Hanah', 'Girma', 'Hanah Girma', 'hanahteshome@gmail.com', 'hanah12345', 987654321, 'Longtiude: 38.7439 and Latitude: 9.026 , Addis Ababa , AA , Ethiopia', 746519834, 'chapa-78654', 1, 0, 0, 0, 0, 0, 0, 0, '2024-06-30'),
...
--
ALTER TABLE `house_table`
  MODIFY `house_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `user_table`
  MODIFY `user_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
